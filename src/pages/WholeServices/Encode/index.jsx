    ...
    <div className="encode-wrapper">
      ...
      <div className="encode-main-body-wrapper">
        ...
        <Card>
          ...
          <p style={{fontSize:"16px",margin:"0 40px 20px 40px",color: "#748189"}}><strong>Tips:</strong> (a) the first and second methods require a file size large than 100KB. (b) the eighth method only encodes English in text and does not support other languages. (c) the maximum file size is 6 MB. Compressed files such as doc or pdf will take longer to encode.</p>
          {/*文件上传组件*/}
          <Uploads

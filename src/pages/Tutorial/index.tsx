      ...
      <div className="tutorial">
        <div className="tutorial-content">
          <div className="Breadcrumb">
            ...
            potentially low maintenance cost and other excellent characteristics make it an ideal alternative medium for information storage, 
            ...
            In addition, it also simulates the sequence errors in the five DNA sequence storage processes of synthesis, decay, PCR, sample, and sequencing. 
            ...
            but also upload DNA sequences to simulate sequence errors during storage by the 'Error Simulation' module. 
            Aiming to provide user-friendly services, this website embeds the most popular methods and platforms related to DNA storage instead of asking users for complex parameters. 
          ...
          <div id="usage">
            ...
            <div id="errorsimu">
              ...
              <div id="simu-report">
                ...
                <p id='text-content'>The report consists of three parts, Stage Summary, Sequences Distribution, and Error Counts. You could also download the simulated file together with the setting information using the “Download” button. </p>
                <ul>

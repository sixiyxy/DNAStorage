...
export const Home: React.FC<HomeProps> = (props) => {
  return (
    ...
    <div className="home-content1" style={{height:"100%",backgroundColor:"#1B5585"}}>
      <h1 style={{color:"white",paddingTop:"100px",fontSize:"30px"}}> <strong>Welcome to the DNA Storage Designer</strong></h1>
      <p style={{color:"white",marginLeft:"160px",marginRight:"160px",paddingTop:"30px",fontSize:"20px",lineHeight:"40px",textAlign:"justify"}}>
      ...
      <Button className="home-button" size="large" shape="round" style={{marginLeft:"280px"}} icon={<ContainerTwoTone/>}>
    ...
    <div className="home-content2" style={{height:"100%",backgroundColor:"white"}}>
      ...
      <h2>Encode/Decode</h2>
        ...
        <Button className="home-button" shape="round" size="large" style={{backgroundColor:"#83c5b7"}}>
